...
const RENDER_DEPLOY_HOOK =
  "https://api.render.com/deploy/srv-d0nfbd0dl3ps73a6u480?key=2XDLpH-mG08";

console.log("Deploying to Render...");

// Trigger the deploy hook
https
  .get(RENDER_DEPLOY_HOOK, (res) => {
    let data = "";
    ...
    res.on("end", () => {
      if (res.statusCode === 200 || res.statusCode === 201) {
        ...
        console.log(
          "Your application will be available shortly at your configured domain.",
        );
      } else {
