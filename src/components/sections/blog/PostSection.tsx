  ...
  return (
    <section className="" style={{ backgroundColor: 'var(--background)' }}>
      <div className="w-full">
        <div className="text-left mb-6 sm:mb-8  pt-6" style={{ borderColor: 'var(--border)' }}>
          <p className="text-sm sm:text-base" style={{ color: 'var(--paragraph)' }}>
            Here are some{' '}
              ...
              >
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-3">
                    <span className="font-figtree text-sm sm:text-base truncate" style={{ color: 'var(--headline)' }}>
                      {post.title}
                    </span>
                  </div>
                </div>
