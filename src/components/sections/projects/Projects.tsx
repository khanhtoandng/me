...
const projectsData: Project[] = [
  {
    id: 'proj_1',
    title: 'Kaiso - ISO Compliance made fast, easy & (almost) fun',
    description: `• Simplify & automate ISO 9001, 14001 & 45001 compliance with our A.I. engine trained by real auditors.\n\n• Developed a secure, scalable web application on AWS Cloud.\n\n• Integrated generative AI features for internal audit reports, generating policies, and more.`,
    type: 'SaaS Application',
    website: 'https://www.kaiso.com/',
    technologies: [
      'TypeScript',
      'GraphQL',
      'RESTful APIs',
...
const techIconMap: Record<string, React.ReactNode> = {
  ...
  'SaaS Multi-Tenant Architecture': (
    <BsFillPeopleFill className="text-blue-700" title="SaaS Multi-Tenant Architecture" />
  ),
  ...
  return (
    <section data-slot="panel" id="projects">
      <div data-slot="panel-header" className="screen-line-after px-4">
        <h2 data-slot="panel-title" className="section-title" style={{ color: 'var(--headline)' }}>
          Projects
        </h2>
          ...
          <div className="flex items-center ">
            <div className="mx-4 flex size-6 bg-[var(--card-background)] h-8 w-8 border  p-1 rounded-full  shrink-0">
              <img
                ...
                onError={(e) => {
                  ;(e.currentTarget as HTMLImageElement).src = 'https://via.placeholder.com/32?text=P'
                }}
                style={{ objectFit: 'contain' }}
              />
            </div>
            <div className="flex-1 border-l border-dashed" style={{ borderColor: 'var(--card-border-color)' }}>
              <button
                type="button"
              ...
              >
                <div className="flex-1">
                  <h3 className="mb-1 leading-snug font-medium" style={{ color: 'var(--card-headline)' }}>
                    {project.title}
                  </h3>
                ...
                <div className="shrink-0" aria-hidden="true" style={{ color: 'var(--paragraph)' }}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width={24}
                    height={24}
                    ...
                    strokeLinejoin="round"
                    className={`lucide ${
                      openProjectId === project.id ? 'lucide-chevrons-down-up' : 'lucide-chevrons-up-down'
                    } size-4`}
                    aria-hidden="true"
