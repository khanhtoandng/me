...
const Recommendations = () => {
  ...
  return (
    <div dir={direction} className="section flex flex-col gap-4 pb-10">
        ...
        >
          <header className="flex items-start gap-2">
            ...
            <div className="pt-2 text-start">
              <h3 className="font-semibold text-[var(--card-headline)]">
                {review.name}
              </h3>
              <p className="text-[var(--card-paragraph)]">{review.title}</p>
            </div>
          </header>

          <p className="mt-2 text-[var(--card-paragraph)]">{review.review}</p>
        </MagicCard>
      ))}
    </div>
  );
