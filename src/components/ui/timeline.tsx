  ...
  return (
    <div className="mx-auto w-full  bg-transparent md:pt-10" ref={containerRef}>
      ...
      <div ref={ref} className="relative mx-auto max-w-[1400px] pb-20">
        {data.map((item, index) => (
          <div className="flex justify-start pt-5 max-md:pt-10 md:gap-10 max-md:ps-[30px]">
            <div className="sticky top-40 z-40 flex max-w-xs flex-col items-center self-start md:w-full md:flex-row lg:max-w-sm">
              <div className="absolute left-3 max-md:left-[-40px] flex h-10 w-10 items-center justify-center rounded-full bg-white dark:bg-black md:left-3">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0   top-0 w-[2px] rounded-full bg-gradient-to-t from-purple-500 from-[0%] via-blue-500 via-[8%]  to-transparent"
          />
        </div>
      </div>
    </div>
