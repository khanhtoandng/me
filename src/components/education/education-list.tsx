...
import { Edit, Trash2, Calendar, MapPin, GraduationCap, Award, Plus } from "lucide-react"
  ...
  if (educations.length === 0) {
    return (
      <Card className="bg-[var(--card-background)] border-[var(--card-border-color)] p-8 text-center">
        <h3 className="text-xl font-semibold text-[var(--card-headline)]">No education entries found</h3>
        <p className="text-[var(--card-paragraph)] mt-2">Start by adding your first education entry</p>
        ...
        <motion.div key={education._id} variants={itemVariants}>
          <Card className="bg-[var(--card-background)] border-[var(--card-border-color)]">
            <CardHeader className="pb-2">
              <div className="flex items-start justify-between">
                <div>
                  <CardTitle className="text-xl text-[var(--card-headline)]">{education.degree}</CardTitle>
            ...
            <CardContent className="pb-2">
              <div className="flex flex-col gap-4">
                ...
                {education.description && (
                  <p className="text-sm text-[var(--card-paragraph)]">{education.description}</p>
                )}
